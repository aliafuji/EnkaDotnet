    ...
    public class GenshinAssets : BaseAssets, IGenshinAssets
    {
        ...
        protected override async Task LoadAssetsInternalAsync()
        {
            var tasks = new List<Task>
            {
                ...
                RunLoaderAsync(LoadTalents),
                RunLoaderAsync(LoadConstellations),
        ...
        public string GetCharacterIconUrl(int characterId)
        {
            if (_characters.TryGetValue(characterId, out var charInfo))
            {
                if (!string.IsNullOrEmpty(charInfo.SideIconName))
                {
                    ...
                    return $"{Constants.DefaultGenshinAssetCdnUrl}{iconName}.png";
                }
            }
            return string.Empty;
        }
        ...
        public string GetWeaponIconUrlFromIconName(string iconName) => !string.IsNullOrEmpty(iconName) ? $"{Constants.DefaultGenshinAssetCdnUrl}{iconName}.png" : string.Empty;
        ...
        public string GetArtifactIconUrlFromIconName(string iconName) => !string.IsNullOrEmpty(iconName) ? $"{Constants.DefaultGenshinAssetCdnUrl}{iconName}.png" : string.Empty;
        ...
        {
            string key = characterId.ToString(CultureInfo.InvariantCulture);
            if (_pfps.TryGetValue(key, out var pfpInfo))
            {
                if (!string.IsNullOrEmpty(pfpInfo.IconPath))
                {
                    ...
                    return $"{Constants.DefaultGenshinAssetCdnUrl}{adjustedIconPath}.png";
                }
            }
        ...
        public string GetNameCardIconUrl(int nameCardId)
        {
            ...
            {
                return $"{Constants.DefaultGenshinAssetCdnUrl}{nameCardInfo.Icon}.png";
            }
            return string.Empty;
        }
        ...
        {
            if (_constellations.TryGetValue(constellationId.ToString(CultureInfo.InvariantCulture), out var constellationInfo))
            {
        ...
        public string GetTalentIconUrl(int talentId)
        {
            ...
            {
                return $"{Constants.DefaultGenshinAssetCdnUrl}{talentInfo.Icon}.png";
            }
            return string.Empty;
        }

        public string GetConstellationIconUrl(int constellationId) => _constellations.TryGetValue(constellationId.ToString(CultureInfo.InvariantCulture), out var constellationInfo) && !string.IsNullOrEmpty(constellationInfo.Icon) ? $"{Constants.DefaultGenshinAssetCdnUrl}{constellationInfo.Icon}.png" : string.Empty;
