...
namespace EnkaDotNet.Serialization
{
    ...
    // EF API Response Models
    [JsonSerializable(typeof(EFApiResponse))]
    [JsonSerializable(typeof(EFPlayerInfoModel))]
    [JsonSerializable(typeof(EFBusinessCardModel))]
    [JsonSerializable(typeof(EFDomainDevModel))]
    [JsonSerializable(typeof(EFDomainModel))]
    [JsonSerializable(typeof(EFAchievementModel))]
    [JsonSerializable(typeof(EFAchievementInfoModel))]
    [JsonSerializable(typeof(EFStatisticModel))]
    [JsonSerializable(typeof(EFCharListEntryModel))]
    [JsonSerializable(typeof(EFCharDataModel))]
    [JsonSerializable(typeof(EFEquipEntryModel))]
    [JsonSerializable(typeof(EFEquipValueModel))]
    [JsonSerializable(typeof(EFEquipEnhanceDataModel))]
    [JsonSerializable(typeof(EFEnhanceFailedEntryModel))]
    [JsonSerializable(typeof(EFEnhanceFailedValueModel))]
    [JsonSerializable(typeof(EFWeaponModel))]
    [JsonSerializable(typeof(EFGemModel))]
    [JsonSerializable(typeof(EFGemTermModel))]
    [JsonSerializable(typeof(EFSkillInfoModel))]
    [JsonSerializable(typeof(EFSkillLevelModel))]
    [JsonSerializable(typeof(EFTalentModel))]
    [JsonSerializable(typeof(EFIntKeyValueModel))]
    // EF Asset Models
    [JsonSerializable(typeof(EFAvatarAssetInfo))]
    [JsonSerializable(typeof(EFAvatarSkillInfo))]
    [JsonSerializable(typeof(EFAvatarNodeSkillInfo))]
    [JsonSerializable(typeof(EFPotAttributeEntry))]
    [JsonSerializable(typeof(EFPotAttrValue))]
    [JsonSerializable(typeof(EFBaseAttributeValue))]
    [JsonSerializable(typeof(EFWeaponAssetInfo))]
    [JsonSerializable(typeof(EFEquipData))]
    [JsonSerializable(typeof(EFEquipItemInfo))]
    [JsonSerializable(typeof(EFEquipSuitInfo))]
    [JsonSerializable(typeof(EFAttrModifierInfo))]
    [JsonSerializable(typeof(EFGemData))]
    [JsonSerializable(typeof(EFGemTermInfo))]
    [JsonSerializable(typeof(EFGemTemplateInfo))]
    [JsonSerializable(typeof(EFSkillAssetInfo))]
    [JsonSerializable(typeof(EFSkillPropInfo))]
    [JsonSerializable(typeof(EFWeaponMetaData))]
    [JsonSerializable(typeof(EFSkillLevelBound))]
    [JsonSerializable(typeof(EFPfpAssetInfo))]
    [JsonSerializable(typeof(EFNameCardAssetInfo))]
    [JsonSerializable(typeof(EFMedalAssetInfo))]
    [JsonSerializable(typeof(Dictionary<string, EFAvatarAssetInfo>))]
    [JsonSerializable(typeof(Dictionary<string, EFWeaponAssetInfo>))]
    [JsonSerializable(typeof(Dictionary<string, EFEquipItemInfo>))]
    [JsonSerializable(typeof(Dictionary<string, EFEquipSuitInfo>))]
    [JsonSerializable(typeof(Dictionary<string, EFGemTermInfo>))]
    [JsonSerializable(typeof(Dictionary<string, EFGemTemplateInfo>))]
    [JsonSerializable(typeof(Dictionary<string, EFSkillAssetInfo>))]
    [JsonSerializable(typeof(Dictionary<string, EFPfpAssetInfo>))]
    [JsonSerializable(typeof(Dictionary<string, EFNameCardAssetInfo>))]
    [JsonSerializable(typeof(Dictionary<string, EFMedalAssetInfo>))]
    [JsonSerializable(typeof(Dictionary<string, List<double>>))]
    [JsonSerializable(typeof(Dictionary<string, Dictionary<string, List<EFSkillLevelBound>>>))]
    [JsonSerializable(typeof(List<EFCharDataModel>))]
    [JsonSerializable(typeof(List<EFCharListEntryModel>))]
    [JsonSerializable(typeof(List<EFEquipEntryModel>))]
    [JsonSerializable(typeof(List<EFSkillLevelModel>))]
    [JsonSerializable(typeof(List<EFIntKeyValueModel>))]
    [JsonSerializable(typeof(List<EFSkillLevelBound>))]
    ...
    [JsonSerializable(typeof(AvatarNameInfo))]
    [JsonSerializable(typeof(EquipmentNameInfo))]
    ...
    [JsonSerializable(typeof(HSREquipmentMetaStats))]
    [JsonSerializable(typeof(HSRMetaData))]
    [JsonSerializable(typeof(HSREquipmentSkillInfo))]
    [JsonSerializable(typeof(HSRSkillTreeMetaInfo))]
    ...
    [JsonSerializable(typeof(Dictionary<string, Dictionary<string, HSRAvatarMetaStats>>))]
    [JsonSerializable(typeof(Dictionary<string, Dictionary<string, HSREquipmentMetaStats>>))]
    [JsonSerializable(typeof(Dictionary<string, Dictionary<string, HSREquipmentSkillInfo>>))]
    [JsonSerializable(typeof(Dictionary<string, Dictionary<string, HSRSkillTreeMetaInfo>>))]
